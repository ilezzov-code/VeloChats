package ru.ilezzov.plugin.velocity.file.message;
...
public class Messages {
    ...
    public static class MessagesSection {
        ...
        public String writeYourself;
        public String replyHelp;
        public String replyNotFound;
        public String spyEnable;
        public String spyDisable;
        public String chatHelp;
        public String chatAccessDeniedForSender;
        public String chatAccessDeniedForTarget;
        public String chatPermissionDenied;
    }
}
